...
// Admin Login Script......
   public function admin_loginchak($admin_email, $admin_pass){
    ...
    public function superAdminDataGet(){
      $sql = "SELECT id, name, email, create_date FROM tbl_admin ORDER BY id DESC";
      $result = $this->db->select($sql);
      return $result;
    } 
    ...
    public function addAdminData($data){
        ...
        if (empty($name) || empty($email) || empty($password)) {
          $msg = '<div class="alert alert-warning" role="alert">
                  Name,Email,password Field Must not be Empty!
                 </div>';
          return $msg;
