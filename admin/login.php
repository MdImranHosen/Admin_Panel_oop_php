...
if (class_exists('Adminclass')) {
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['login_admin'])) {
      ...
      if (empty($admin_email) || empty($admin_pass)) {
        ...
        $login_mas = $al->admin_loginchak($admin_email,$admin_pass);
      }
   }
...
<head>
  ...
  <link rel="icon" href="dist/img/hopeit.png">
  <!-- Bootstrap 3.3.7 -->
...
<div class="login-box">
  ...
  <!-- /.login-logo -->
    ...
    <p style="padding-top: 20px;padding-bottom: 0px;margin-bottom: 0px;" align="center">Copyright &copy; <?php echo date("Y"); ?> <a target="_blank" href="https://hopeitltd.com/">Hope IT Limited</a></p>
  </div>
  <!-- /.login-box-body -->
</div>
<!-- /.login-box -->
